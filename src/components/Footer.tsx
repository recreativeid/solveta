...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-gray-200 pt-16 pb-10 bg-white relative">
      <div className="max-w-[1160px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          {/* Col 1: Brand & Contact */}
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-brand-800 flex items-center justify-center text-white">
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="flex flex-col gap-1.5 text-xs text-gray-600">
              <a
                ...
                className="flex items-center gap-2 hover:text-brand-800 transition-colors"
              >
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-400">
          ...
          <Link
            href="/admin"
            className="opacity-20 hover:opacity-100 transition-opacity flex items-center gap-1 text-[10px] text-gray-400 hover:text-brand-800"
            title="Hidden Developer Login"
          >
