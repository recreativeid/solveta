...
export const defaultProjects: CarouselItem[] = [
  {
    ...
    tag: "Landingpage",
    titleLine1: "KONSERVASI AKUATIK",
    titleLine2: "– KURSUS & CLUB RENANG",
    desc: "Website landingpage kursus & club renang profesional.",
    img: getAssetPath("/images/portfolio/konservasi-akuatik.jpg"),
    tags: ["Custom", "SOLVETA"],
    ctaText: "Kunjungi Website",
    ctaUrl: "https://konservasiakuatik.space/",
  },
  {
    id: "port-1",
    tag: "Custom System",
    titleLine1: "SQUABUMIN.ID",
    titleLine2: "– COMPANY PROFILE HERBAL",
    desc: "Company profile product madu squabumin dari CV Herbal Indo Utama.",
    img: getAssetPath("/images/portfolio/squabumin.jpg"),
    tags: ["Herbal"],
    ctaText: "Kunjungi Website",
    ctaUrl: "https://squabumin.id",
  },
  {
    id: "port-2",
    tag: "Web Application",
    titleLine1: "CUANGO",
    titleLine2: "– POS UMKM & AI INVENTORY",
    desc: "POS UMKM & Inventaris Canggih untuk UMKM bertenaga AI.",
    img: getAssetPath("/images/portfolio/cuango.jpg"),
    tags: ["UMKM Technology"],
    ctaText: "Kunjungi Website",
    ctaUrl: "http://localhost/cuango",
  },
  {
    id: "port-3",
    tag: "Website & Presence",
    titleLine1: "POS HALTEA INDONESIA",
    titleLine2: "– MANAGEMENT SYSTEM",
    desc: "Sistem POS Management Haltea Indonesia terpadu dan otomatis.",
    img: getAssetPath("/images/portfolio/haltea.jpg"),
    tags: ["UMKM"],
    ctaText: "Kunjungi Website",
    ctaUrl: "https://recreativeid.github.io/haltea/",
  },
  {
    id: "port-4",
    tag: "E-Commerce",
    titleLine1: "LANDING PAGE VISUAL GENIX",
    titleLine2: "– AI AFFILIATE",
    desc: "Landingpage company profile Visual Genix | AI Affiliate Generator.",
    img: getAssetPath("/images/portfolio/visualgenix.jpg"),
    tags: ["E-Commerce", "Inventory"],
    ctaText: "Kunjungi Website",
    ctaUrl: "https://v0-visualgenixaffiliate.vercel.app/",
  },
  {
    id: "port-5",
    tag: "Corporate Profile",
    titleLine1: "TIDURNYENYAK.COM",
    titleLine2: "– HERBATDR PROFILE",
    desc: "Website company profile produk HerbaTDR dari CV Herbal Indo Utama.",
    img: getAssetPath("/images/portfolio/tidurnyenyak.jpg"),
    tags: ["Fintech", "Corporate"],
    ctaText: "Kunjungi Website",
    ctaUrl: "https://tidurnyenyak.com",
  },
];
